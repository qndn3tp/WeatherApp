...
extension Font {
    // HeadTitle Styles
    static let weatherLarge = Font.system(size: 50, weight: .thin)
    
    // Headline Styles
    static let headlineLarge = Font.system(size: 22, weight: .bold)
    static let headlineMedium = Font.system(size: 20, weight: .bold)
    
    // Title Styles
    static let titleLarge = Font.system(size: 22, weight: .bold)
    static let titleMedium = Font.system(size: 19, weight: .bold)
